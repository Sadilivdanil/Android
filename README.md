...
1. Настроить PostgreSQL и создать таблицу `cell_telemetry` (см. схему в `Database.cpp`)
2. Запустить сервер: `./telemetry_server`
3. Отправить тестовые данные: `echo "12:34:56|55.0302|82.9204|150|5|LTE|pci=123|rsrp=-85|rsrq=-12|rssi=-65|sinr=15" | nc localhost 5555`
